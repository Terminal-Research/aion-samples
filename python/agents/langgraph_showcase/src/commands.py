...
COMMANDS: tuple[Command, ...] = (
    ...
    Command(
        key="composite",
        summary="One artifact streamed in several appended chunks",
        api="emit_artifact(append=, is_last_chunk=)",
        source="src/nodes/artifacts.py",
    ),
    Command(
        key="ask",
